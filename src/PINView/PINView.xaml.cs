...
namespace PINView.Maui
{
  ...
  public partial class PINView : ContentView
  {
    ...
    private BoxTemplate CreateBox(char? charValue = null)
    {
      ...
      boxTemplate.BoxBorder.GestureRecognizers.Add(new TapGestureRecognizer()
      {
        Command = new Command(BoxTapCommandExecute),
      });

      boxTemplate.ValueContainer.GestureRecognizers.Add(new TapGestureRecognizer()
      {
        Command = new Command(BoxTapCommandExecute),
      });

      boxTemplate.Dot.GestureRecognizers.Add(new TapGestureRecognizer()
      {
        Command = new Command(BoxTapCommandExecute),
      });

      boxTemplate.CharLabel.GestureRecognizers.Add(new TapGestureRecognizer()
      {
        Command = new Command(BoxTapCommandExecute),
      });
    ...
    /// </summary>
    private void BoxTapCommandExecute()
    {
